...
11. Give your robot a friendly name (i.e. DogFinder), and set the Architecture to ARMHF.  By setting this value, you're telling RoboMaker to use the ARMHF bundle when deploying to this robot.
...
13.  For *IAM role*, choose "dogfinder-deployment-role".  This role was created in exercise 1 of this worksop.  This role is assumed by your robot application when it runs on your device and gives your device permission to access AWS services on your behalf.
...
27. Choose the Fleet and Robot application (DogFinder_robot) you created earlier.  

28. For *Robot application version*, choose *Create new*, and click **Create** on the confirmation.  This will create a new version for the DogFinder_application robot application.
